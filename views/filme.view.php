<?php 
    ...
    require "../components/ratingButton.php";
...
?>
<?php if(auth()): ?>
<section id="avaliacao" class="absolute hidden w-full h-screen justify-center items-center z-50">
    <div class="w-[800px] h-[600px] flex flex-col mx-auto p-10 gap-8 bg-gray-200 stroke-gray-300 rounded-2xl relative">
        <div onclick="fecharAvaliacao()">
            <?php iconButtonSimple('<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="fill-gray-500 hover:fill-purple-light" viewBox="0 0 256 256"><path d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z"></path></svg>'); ?>
        </div>
        ...
        <form method="POST" action="/criar-avaliacao">
            <div class="flex flex-col w-full gap-6">
                ...
                <?php endif; ?>
                <div onclick="publicar()" class="flex justify-end self-end">
...
<?php endif; ?>
<section id="fundoBlur2" class='w-full relative'>
...
<section id="fundoBlur3" class="flex flex-col max-w-1192 mx-auto pt-16 gap-10">
    <div class="flex justify-between items-center gap-2">
        <h3 class="title-xl text-gray-700">Avaliações</h3>
        <?php if(auth()) : ?>
        <div onclick="avaliarFilme()"><?php buttonSimple('<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="fill-white" viewBox="0 0 256 256"><path d="M239.18,97.26A16.38,16.38,0,0,0,224.92,86l-59-4.76L143.14,26.15a16.36,16.36,0,0,0-30.27,0L90.11,81.23,31.08,86a16.46,16.46,0,0,0-9.37,28.86l45,38.83L53,211.75a16.38,16.38,0,0,0,24.5,17.82L128,198.49l50.53,31.08A16.4,16.4,0,0,0,203,211.75l-13.76-58.07,45-38.83A16.43,16.43,0,0,0,239.18,97.26Zm-15.34,5.47-48.7,42a8,8,0,0,0-2.56,7.91l14.88,62.8a.37.37,0,0,1-.17.48c-.18.14-.23.11-.38,0l-54.72-33.65a8,8,0,0,0-8.38,0L69.09,215.94c-.15.09-.19.12-.38,0a.37.37,0,0,1-.17-.48l14.88-62.8a8,8,0,0,0-2.56-7.91l-48.7-42c-.12-.1-.23-.19-.13-.5s.18-.27.33-.29l63.92-5.16A8,8,0,0,0,103,91.86l24.62-59.61c.08-.17.11-.25.35-.25s.27.08.35.25L153,91.86a8,8,0,0,0,6.75,4.92l63.92,5.16c.15,0,.24,0,.33.29S224,102.63,223.84,102.73Z"></path></svg>', 'Avaliar Filme'); ?></div>
        <?php endif; ?>
    </div>
    <?php if(auth() && ! $avaliacoes) : ?>
        <div class="flex flex-col w-full justify-center items-center gap-5 mt-8">
            ...
            <div onclick="avaliarFilme()"  class="flex justify-center items-center gap-2 cursor-pointer">
    ...
    <?php endif; ?>
    <?php if(auth()){ foreach($avaliacoes as $avaliacao) : ?>
    ...
    <?php endforeach; } else{ ?>
        <div class="flex flex-col w-full justify-center items-center gap-5 mt-8">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" class="fill-gray-400" viewBox="0 0 256 256"><path d="M229.52,74.21a8,8,0,0,0-7.13-2A44,44,0,0,0,168,41.67a44,44,0,0,0-80,0,44,44,0,0,0-54.4,30.51,8,8,0,0,0-9.4,9.65L54.76,211.67A16,16,0,0,0,70.34,224H185.66a16,16,0,0,0,15.58-12.33L231.79,81.83A8,8,0,0,0,229.52,74.21ZM76,56a27.68,27.68,0,0,1,13.11,3.26,8,8,0,0,0,11.56-5.34,28,28,0,0,1,54.66,0,8,8,0,0,0,11.56,5.34A28,28,0,0,1,207,76.54l-38.56,11-34.49-13.8a16,16,0,0,0-11.88,0L87.57,87.56,49,76.54A28,28,0,0,1,76,56ZM70.34,208,42.91,91.44l37.85,10.81L94.86,208ZM145,208H111L96.75,101.12,128,88.62l31.25,12.5Zm40.66,0H161.14l14.1-105.75,37.85-10.81Z"></path></svg>
            <div class="text-center">
                <p class="text-md-regular text-gray-600">Você precisa estar logado para visualizar os comentários.</p>
                <p class="text-md-regular text-gray-600">Que tal você se logar ou se registrar para visualizar os comentários? Assim você também pode dar sua opnião sobre este filme.</p>
            </div>
            <a href="/register"  class="flex justify-center items-center gap-2 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="fill-gray-500" viewBox="0 0 256 256"><path d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z"></path></svg>
                <p class="text-md-regular text-gray-500">Logar / Registrar-se</p>
            </a>
        </div>
    <?php } ?>
</section>