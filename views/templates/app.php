...
<body class="bg-gray-100 text-white">
    <header class="w-full">
        <nav id="fundoBlur" class="flex w-full mx-auto justify-between items-center px-8 py-4">
                ...
                <div class="flex gap-3 input-text text-gray-600">
                    <div class="flex justify-center items-center pr-3 gap-3">
                        ...
                        <?php if($usuario->avatar) : ?>
                            <a href="/usuario"><img src="<?=$usuario->avatar?>" alt="Avatar Próprio" class="w-8 h-8 border border-purple-base rounded-md" /></a>
                        <?php else : ?>
                            <a href="/usuario"><img src="/images/Logo.svg" alt="Avatar Padrão" class="w-8 h-8 border border-purple-base rounded-md" /></a>
                        <?php endif; ?>
                    </div>
