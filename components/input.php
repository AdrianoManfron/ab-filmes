...
?>
    ...
    <input type="<?=$type?>" name="<?=$name?>" class="<?= $widthBox ?> bg-gray-100 border border-gray-300 input-text text-gray-700 rounded-md focus:outline-purple-base pl-12 py-3 pr-4" placeholder="<?= $text ?>" />
<?php
}
