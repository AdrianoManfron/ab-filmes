<a href="/login" class="flex w-full justify-center items-center px-5 py-3 gap-2 bg-purple-base rounded-md duration-150 hover:bg-purple-light">Login / Registrar
    <div><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#ffffff" viewBox="0 0 256 256">
